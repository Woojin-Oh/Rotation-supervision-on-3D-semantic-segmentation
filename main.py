...
class Experiment(object):
    def __init__(self, settings: Option):
        ...
        #torch.distributed.barrier() #다른 프로세스들이 여기까지 수행하기를 기다리게함
        ...
        # Init trainer - 안에 dataloader, 스케쥴러, optimizer 다 있음
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_split', action='store_true', help='run inference on the test split') #이걸로 test 세팅
    parser.add_argument('--save_eval_results', action='store_true', help='save the predictions') #이걸로 test
